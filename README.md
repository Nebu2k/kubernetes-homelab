...
│   │   ├── alertmanager-notifications-sealed.yaml
│   │   ├── alertmanager-notifications-unsealed.yaml.example
...
│   │   ├── ingress.yaml
│   │   ├── kustomization.yaml
│   │   ├── mealie-backup-token-sealed.yaml
│   │   ├── mealie-backup-token-unsealed.yaml.example
...
│   │   ├── pv.yaml
│   │   ├── pvc.yaml
│   │   ├── s3-mealie-backup-credentials-sealed.yaml
│   │   ├── s3-mealie-backup-credentials-unsealed.yaml.example
│   │   └── service.yaml
│   ├── metallb/
│   │   ├── kustomization.yaml
...
3. **All other secrets** (each optional, depending on which apps you keep):
   ...
   cp manifests/kube-prometheus-stack/alertmanager-notifications-unsealed.yaml.example \
      manifests/kube-prometheus-stack/alertmanager-notifications-unsealed.yaml
   ...
   cp manifests/mealie/mealie-backup-token-unsealed.yaml.example \
   ...
   cp manifests/mealie/s3-mealie-backup-credentials-unsealed.yaml.example \
